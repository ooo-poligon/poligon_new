...
function recall_form() {
	...
	$.ajax({
		...
		error: function(e, c) {
			alert("ÐÐ¾Ð·Ð½Ð¸ÐºÐ»Ð° Ð¾ÑÐ¸Ð±ÐºÐ°: " + e.responseCode)
		}
	})
};
