...
ActiveRecord::Schema.define(version: 20_180_619_212_433) do
  ...
  create_table 'analogs', force: :cascade do |t|
    ...
    t.text    'addition',     limit: 16_777_215
  ...
  create_table 'analogs_variants', force: :cascade do |t|
    t.text    'title',     limit: 65_535, null: false
  ...
  create_table 'categories', force: :cascade do |t|
    ...
    t.string  'image_path',  limit: 255
    t.text    'more_info',   limit: 65_535
    t.text    'summary',     limit: 65_535
  ...
  create_table 'examples', force: :cascade do |t|
    ...
    t.string   'title',      limit: 255
    t.text     'issue',      limit: 65_535
    t.text     'solution',   limit: 65_535
    t.text     'advantages', limit: 65_535
    t.datetime 'created_at',               null: false
    t.datetime 'updated_at',               null: false
  end
  ...
  add_index 'examples_tags', %w[example_id tag_id], name: 'index_examples_tags_on_example_id_and_tag_id', using: :btree
  add_index 'examples_tags', %w[tag_id example_id], name: 'index_examples_tags_on_tag_id_and_example_id', using: :btree
  ...
  create_table 'products', force: :cascade do |t|
    ...
    t.string  'title',              limit: 255, default: '', null: false
    t.text    'description',        limit: 65_535
    t.text    'anons',              limit: 65_535
    t.string  'article',            limit: 255
    t.text    'full_description',   limit: 65_535
    t.integer 'available',          limit: 4
    t.text    'delivery_time',      limit: 65_535
  ...
  create_table 'vendors', force: :cascade do |t|
    t.string  'title',       limit: 255, null: false
    t.text    'address',     limit: 4_294_967_295
    t.text    'description', limit: 4_294_967_295
